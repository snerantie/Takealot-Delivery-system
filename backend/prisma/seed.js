// Plain JS seed runnable in production with `node prisma/seed.js`.
// (The TypeScript version uses tsx, which is a devDependency and isn't
// available on Render's free tier at runtime.)
